...
// async function sendOrderDispatchEmail(customerEmail: string, customerName: string, deliveryAgentEmail: string, deliveryAgentName: string, meals: { name: string; quantity: number; restaurant: string; totalPrice: number;}[]) {
...
//       <p>Dear ${customerName}, your order has been dispatched. Here are the details:</p>
//       <ul>
//         ${meals.map(meal => `<li>${meal.quantity} x ${meal.name} from ${meal.restaurant} - Total: $${meal.totalPrice}</li>`).join('')}
//       </ul>
//     `,
//   };
...
//       <p>Dear ${deliveryAgentName}, you have been assigned a new order. Here are the details:</p>
//       <ul>
//         ${meals.map(meal => `<li>${meal.quantity} x ${meal.name} from ${meal.restaurant} - Total: $${meal.totalPrice}</li>`).join('')}
//     </ul>
