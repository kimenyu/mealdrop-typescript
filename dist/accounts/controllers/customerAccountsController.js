...
const createCustomer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const existingPhoneNum = yield customer_1.default.findOne({
            phoneNum
        });
        if (existingPhoneNum) {
            return res.status(400).json({ message: "Phone number already exists" });
        }
        const existingUsername = yield customer_1.default.findOne({
            username
        });
        if (existingUsername) {
        ...
        const existingEmail = yield customer_1.default.findOne({
            email
        });
        if (existingEmail) {
...
const loginCustomer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ userId: customer._id, userEmail: customer.email }, jwtsecret, { expiresIn: "1h" });
